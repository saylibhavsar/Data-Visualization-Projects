...
<img src="Images/regional-price-parities.png" alt="Regional Price Parity" width="600" align="center"/>
> Graph by <a href="https://cdn.howmuch.net/articles/regional-price-parities-by-state-cfce.jpg">howmuch.net</a>, Source <a href="https://www.bea.gov/data/prices-inflation/regional-price-parities-state-and-metro-area">U.S. Bureau of Economic Analysisr</a>
...
<br>
* **Usefulness (8/10)** - Considering that the visualization is meant economics and people who are interested in learning about purchasing power, this chart does a good job of telling a story of which US states are the most expensive (and cheapest) for everyday goods and services.
* **Completeness (8/10)** - The chart has all the information necessary to communicate the intended level of understanding the comparison between US states’ purchasing power. It also has a baseline (measure of norm) to compare the actual values with (Avg. US Regional Price Parity = 100). Maybe, a little more clarity on purchase parity and how it works could be good.
